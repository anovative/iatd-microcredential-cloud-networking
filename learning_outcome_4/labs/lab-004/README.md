Okay, here's the lab focusing on securing a database subnet using NSGs, as per your specifications.
...
3.  **Configure NSG-DB (Allow Inbound TCP 1433 from App Subnet):**
